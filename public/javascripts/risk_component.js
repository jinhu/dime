...
const LAYERDELTA = 150;					// the amount of pixels children of an element will pop forward
...
//Class RiskComponent
	...
	RiskComponent.prototype.CreateElement = function(baseElement){
		if (this.element == null) {
			...
			jQuery(this.element).bind("touchstart",this.OnTouchStart);
			jQuery(this.element).bind("mousedown",this.OnTouchStart);
		}
		this.RePosition();
	}
